...
def load_data():
    try:
        ...
        if os.path.exists('streamlit/hasil_dss_forecast_2024_2025_dengan_label.csv'):
            dss = pd.read_csv('streamlit/hasil_dss_forecast_2024_2025_dengan_label.csv')
...
with st.container():
    ...
    df_prediksi_cuaca = pd.read_csv('streamlit/hasil_prediksi_jangka_panjang.csv')
